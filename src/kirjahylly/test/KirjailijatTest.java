 ...
 * @version 2020.07.31 15:40:15 // Generated by ComTest
 *
 */
...
public class KirjailijatTest {
   ...
   */
  @Test
  public void testLueTiedostosta103() throws SailoException {    // Kirjailijat: 103
    Kirjailijat kirjailijat = new Kirjailijat(); 
    ...
    fail("Kirjailijat: 115 Did not throw SailoException");
    ...
    assertEquals("From: Kirjailijat line: 125", kirjailija21.toString(), i.next().toString()); 
    assertEquals("From: Kirjailijat line: 126", kirjailija11.toString(), i.next().toString()); 
    assertEquals("From: Kirjailijat line: 127", kirjailija22.toString(), i.next().toString()); 
    assertEquals("From: Kirjailijat line: 128", kirjailija12.toString(), i.next().toString()); 
    assertEquals("From: Kirjailijat line: 129", kirjailija23.toString(), i.next().toString()); 
    assertEquals("From: Kirjailijat line: 130", false, i.hasNext()); 
    kirjailijat.lisaa(kirjailija23); 
    kirjailijat.tallenna(); 
    assertEquals("From: Kirjailijat line: 133", true, ftied.delete()); 
    File fbak = new File(tiedNimi+".bak"); 
    assertEquals("From: Kirjailijat line: 135", true, fbak.delete()); 
  } // Generated by ComTest END
  ...
  /** testIterator248 */
  @Test
  public void testIterator248() {    // Kirjailijat: 248
    Kirjailijat kirjailijat = new Kirjailijat(); 
    ...
    assertEquals("From: Kirjailijat line: 258", kirj21, i2.next()); 
    assertEquals("From: Kirjailijat line: 259", kirj11, i2.next()); 
    assertEquals("From: Kirjailijat line: 260", kirj22, i2.next()); 
    try {
    assertEquals("From: Kirjailijat line: 261", kirj11, i2.next()); 
    fail("Kirjailijat: 261 Did not throw NoSuchElementException");
    } catch(NoSuchElementException _e_){ _e_.getMessage(); }
  } // Generated by ComTest END


  // Generated by ComTest BEGIN
  /** testAnnaKirjailijat276 */
  @Test
  public void testAnnaKirjailijat276() {    // Kirjailijat: 276
    ...
    Kirjailija kirj101 = kirjailijaat.annaKirjailijat(3);  //TODO: kirjailijat lisää testeissä tunnusNroaan.. korjaa
    Kirjailija kirj102 = kirjailijaat.annaKirjailijat(5); 
    assertEquals("From: Kirjailijat line: 288", true, kirj101 == kirj21); 
    assertEquals("From: Kirjailijat line: 289", false, kirj102 == kirj12); 
    Kirjailija kirj103 = kirjailijaat.annaKirjailijat(4); 
    assertEquals("From: Kirjailijat line: 291", true, kirj103 == kirj11); 
  } // Generated by ComTest END


  // Generated by ComTest BEGIN
  /** testAnnaKirjailijat305 */
  @Test
  public void testAnnaKirjailijat305() {    // Kirjailijat: 305
    Kirjailijat kirjailijat = new Kirjailijat(); 
    ...
    assertEquals("From: Kirjailijat line: 316", 3, loytyneet.size()); 
    assertEquals("From: Kirjailijat line: 317", true, loytyneet.get(0) == kirj25); 
    assertEquals("From: Kirjailijat line: 318", true, loytyneet.get(2) == kirj27); 
    assertEquals("From: Kirjailijat line: 319", false, loytyneet.get(0) == kirj17); 
  } // Generated by ComTest END
}